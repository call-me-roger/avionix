...
`npm run bridge -- --open` on the X-Plane PC. The connection form is prefilled with the page's own
host and port; press Connect. See `docs/connector.md` for the full pairing protocol.
